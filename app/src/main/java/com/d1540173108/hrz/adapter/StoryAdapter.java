...
public class StoryAdapter extends BaseRecyclerviewAdapter<DataBean>{
    public StoryAdapter(Context act, List<DataBean> listBean) {
        super(act, listBean);
    }
    ...
    protected RecyclerView.ViewHolder onCreateViewHolde(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.i_story, parent, false));
    }
