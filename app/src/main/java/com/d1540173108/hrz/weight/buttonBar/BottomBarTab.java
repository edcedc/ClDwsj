package com.d1540173108.hrz.weight.buttonBar;
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_gray));
    ...
    public void setSelected(boolean selected) {
        ...
        switch (mTabPosition){
            case 0:
                mIcon.setImageResource(selected? R.mipmap.y25 : R.mipmap.icon_sy);
                break;
            case 1:
                mIcon.setImageResource(selected? R.mipmap.icon_fx : R.mipmap.y1);
                break;
            case 2:
                mIcon.setImageResource(selected? R.mipmap.y5 : R.mipmap.icon_wd);
                break;
        }
        if (selected) {
