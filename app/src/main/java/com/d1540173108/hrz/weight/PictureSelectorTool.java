...
//                .compressSavePath(getPath())//压缩图片保存地址
    ...
    public static void photo(Context act, int request, boolean circleDimmedLayer){
        p(act, request, true, circleDimmedLayer);
    }
    public static void photo(Context act, int request, boolean enableCrop, boolean circleDimmedLayer){
        p(act, request, enableCrop, circleDimmedLayer);
    }

    public static void photo(Context act, boolean enableCrop, int request){
        p(act, request, true, false);
    }

    private static void p(Context act, int request, boolean enableCrop , boolean circleDimmedLayer){
